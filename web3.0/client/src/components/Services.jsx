...
const ServiceCard = ({color, title, icon, subtitle}) => (
    <div className="flex flex-row justify-start items-center, white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl">
        ...
        <div className='ml-5 flex flex-col flex-1'>
            ...
            <p className="mt-2 text-white test-sm md:w-9/12">{subtitle}</p>
...
const Services = () => { 
    return (
        <div className = "flex flex-col md:flex-roww-full justify-center items-center gradient-bg-services">
            <div className="flex mf:flex-row flex-col text-center justify-between md:p-20 py-12">
